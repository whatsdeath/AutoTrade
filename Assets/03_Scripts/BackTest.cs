...
public static class BackTest
{
    ...
    public static double TestMARSIup(List<CandlesParameters> parameters, int RSIpower, float penalty, int power1, int power2)
    {
        ...
        DebugByPlatform.Debug.LogOnlyEditer($"MA1 = {power1}, MA2 = {power2} // ({buyCondition}/{sellCondition}/{RSIpower}) 거래횟수 : {tradeCount}, 성공률 : {1 - (failCount / tradeCount)}, 금액 : {(money + (buyPrice * buyUnitCount)).ToString("#,###")}");
        ...
        float downbuy, float downsell, int downRSIpower ,float penalty)
    {
        ...
        DebugByPlatform.Debug.LogOnlyEditer($"MA1 = {power1}, MA2 = {power2} // 상승({upbuy}/{upsell}/{upRSIpower}) // 하락({downbuy}/{downsell}/{downRSIpower}) 거래횟수 : {tradeCount}, 성공률 : {1 - (failCount / tradeCount)}, 금액 : {(money + (buyPrice * buyUnitCount)).ToString("#,###")}");
    ...
    public static double TestMA(List<CandlesParameters> parameters, float penalty, int power1, int power2)
    {
        ...
        DebugByPlatform.Debug.LogOnlyEditer($"MA1 = {power1}, MA2 = {power2} // 거래횟수 : {tradeCount}, 성공률 : {1 - (failCount / tradeCount)}, 금액 : {(money + (buyPrice * buyUnitCount)).ToString("#,###")}");
        ...
        float downbuy, int downbuypower, float downsell, int downsellpower, float penalty)
    {
        ...
        DebugByPlatform.Debug.LogOnlyEditer($"MA1 = {power1}, MA2 = {power2} // 상승({upbuy}/{upbuypower}//{upsell}/{upsellpower}) // 하락({downbuy}/{downbuypower}//{downsell}/{downsellpower}) 거래횟수 : {tradeCount}, 성공률 : {1 - (failCount / tradeCount)}, 금액 : {(money + (buyPrice * buyUnitCount)).ToString("#,###")}");
